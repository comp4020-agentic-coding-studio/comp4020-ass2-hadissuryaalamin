...
<img src="../../src/decks/assets/week-10/handwashing.jpg" alt="A person washing hands with soap under running water at a sink, the clean and separate steps of the four-step food safety framework" style="max-height: 200px; width: auto; margin: 10px auto; display: block;" />
...
<img src="../../src/decks/assets/week-10/meat-thermometer.jpg" alt="A probe thermometer inserted into a roasting joint of meat, reading its internal temperature directly rather than by estimate" style="max-height: 80px; width: auto; margin: 4px auto 0; display: block;" />
