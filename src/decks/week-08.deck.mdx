...
<svg viewBox="0 0 760 120" width="700" style="max-width: 100%; height: auto; max-height: 150px;" role="img" aria-label="Timeline strip showing the four preparation categories in order: finished ahead, held, made to order, sequenced">
  <defs>
