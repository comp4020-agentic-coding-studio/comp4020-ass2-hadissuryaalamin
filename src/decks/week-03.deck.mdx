...
<img src="../../src/decks/assets/week-03/chicken-leg-quarters.jpg" alt="Raw chicken leg quarters, thigh and drumstick still jointed together, separated from the rest of the bird" style="max-height: 330px; width: 100%; object-fit: contain;" />
...
<img src="../../src/decks/assets/week-03/fridge-thermometer.jpg" alt="A hand holds a refrigerator appliance thermometer clipped to a shelf, its dial needle sitting just below the 40 degrees Fahrenheit REF mark, with raw poultry visible on the shelf below" style="max-height: 320px; width: 100%; object-fit: contain;" />
