...
![bg blur:2px brightness:0.5](./assets/week-09/apple.jpg)
...
![bg right:32% contain](./assets/week-09/bananas.jpg)
...
![Oranges, the non-climacteric fruit in this week's nutrition table](./assets/week-09/oranges.jpg)
