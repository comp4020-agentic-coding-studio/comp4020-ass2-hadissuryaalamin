...
![bg right:32% contain](../../src/decks/assets/week-07/knife-set.jpg)
...
<div style="display: flex; justify-content: center; margin: 4px auto 0;">
<svg viewBox="0 0 700 240" width="360" style="max-width: 100%; height: auto; max-height: 124px;" role="img" aria-label="Labelled diagram of a chef's knife in profile, showing the spine, edge, bevel, heel, tip, bolster and tang">
...
![bg right:30% contain](../../src/decks/assets/week-07/sharpening-stone.jpg)
