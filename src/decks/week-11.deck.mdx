...
<img src="../../src/decks/assets/week-11/thermometer-cooking.jpg" alt="A dial oven thermometer with a long metal probe, its face marked in Celsius from 50 to 300 and printed with icons for beef, pork and poultry at different temperature bands; the red needle points to roughly 90 degrees Celsius." style="max-height: 205px; width: auto; margin: 10px auto; display: block;" />
